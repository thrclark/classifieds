...
<div class="modal post-detail fade" id="admin_ad_detail_expired" tabindex="-1" role="dialog" aria-labelledby="admin_ad_detail_expired" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body demojs-admin-defaultview">
                <dl class="row">
                    ...
                    <dd class="col-12 ccf-postdetail-title">$25</dd>
                    <dt class="sr-only">
                    ...
                    <dd class="col-12 pre-wrap">The First Semester 4th edition edition of the little study guide for organic chem 1, okay condition (marking on some pages).</dd>
                    <dt class="col-sm-3">
