...
<div class="modal fade" id="ad_detail2-4" tabindex="-1" role="dialog" aria-labelledby="ad_detail2-4" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="container ad-body">
                ...
                <dl class="row">
                    ...
                    <dd class="col-sm-9 col-lg-10">This is a saxophone. </dd>
