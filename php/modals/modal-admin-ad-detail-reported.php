...
<div class="modal post-detail fade" id="admin_ad_detail_reported" tabindex="-1" role="dialog" aria-labelledby="admin_ad_detail_reported" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header demojs-admin-view-policy" style="display:none">
            ...
            <div class="modal-body demojs-admin-confirm-adremove" style="display:none">
                ...
                <div class="form-check demojs-adminactiontoggle">
                    ...
                    <label class="form-check-label" for="takeadminaction1"> Yes, deactivate ad and take administrative action on user. </label>
                </div>
                <div class="form-check demojs-adminactiontoggle">
                    <input class="form-check-input" type="radio" name="takeactiontoggle1" id="justdeactivate2" value="2">
                    <label class="form-check-label" for="justdeactivate2"> No, just deactivate this ad. </label>
                </div>
            </div>
            <div class="modal-footer demojs-admin-confirm-adremove" style="display:none">
                ...
                <button class="btn btn-primary demojs-btn-performactions" style="display:none" onclick="location.href='admin-usermaintenance-user0.php';">Next...</button>
