...
<div class="modal fade" id="pub_customheader" tabindex="-1" role="dialog" aria-labelledby="pub_customheader" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Custom header HTML</h5>
