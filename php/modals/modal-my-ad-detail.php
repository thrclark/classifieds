            ...
            <div class="modal-footer">
                <div class="container-fluid px-0">
                    <div class="row align-items-center">
                        ...
                        <div class="rbt-button-group rbt-right-group">
                        	<!-- <div class="col-auto"> <a href="#" class="font-italic small">Report this</a> </div> -->
                        	<button type="button" class="btn btn-outline-primary mod-actions"> <span class="">Edit</span></button> 
                        	<button type="button" class="btn btn-outline-primary mod-actions"> <span class="">Remove</span></button>
                        </div>
                    </div>
                </div>
            </div>
