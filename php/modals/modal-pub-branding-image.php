<div class="modal fade" id="pub_brandingimage" tabindex="-1" role="dialog" aria-labelledby="pub_brandingimage" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label class="control-label" for="appemail"> Application Logo Image </label>
                    <small id="textfieldHelp" class="form-text text-muted">Select an image to be used as an application logo in the header.</small>
