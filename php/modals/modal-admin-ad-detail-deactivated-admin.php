...
<div class="modal post-detail fade" id="admin_ad_detail_deactivated_admin" tabindex="-1" role="dialog" aria-labelledby="admin_ad_detail_deactivated_admin" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header demojs-admin-defaultview">
                <h3 class="modal-title" id="exampleModalLabel">Offering ride to Indy Dec 21 around 10:30am  </h3>
            ...
            <div class="modal-body demojs-admin-defaultview">
                <dl class="row">
                    ...
                    <dd class="col-12 ccf-postdetail-title">Help pay for gas</dd>
                    <dt class="sr-only">
                    ...
                    <dd class="col-12 pre-wrap">Offering ride to Indy Dec 21 around 10:30am </dd>
                    <dt class="col-sm-3">
