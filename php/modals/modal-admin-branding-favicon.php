            ...
            <div class="modal-body">
                <div class="form-group">
                    <div class="mb-3">
                        ...
                        <div id="textfieldHelp" class="small helper-text">Select a favicon file (.ico format) to be displayed by web browsers next to the URL in the address bar and in browser bookmarks.</div>
                    </div>
