...
<div class="modal fade" id="pub_favicon" tabindex="-1" role="dialog" aria-labelledby="pub_favicon" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Favicon Icon</h5>
                <button type="button" class="close" aria-label="Close" data-dismiss="modal"> <span class="rbt-icon-close"></span> </button>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <div class="mb-3">
                        <label class="" for="appemail"> Select favicon</label>
                        <div id="textfieldHelp" class="ccf-instructional-text">Select a favicon file (.ico format) to be displayed by web browsers next to the URL in the address bar and in browser bookmarks.</div>
                    </div>
                        ...
                        <div ng-reflect-form="[object Object]" class="ng-untouched ng-invalid ng-dirty">
                            <div ng-reflect-name="media" class="ng-untouched ng-valid ng-dirty">
                                ...
                                <div class="img-preview" dnd-sortable-container="" draggable="false" ng-reflect-sortable-data="" style="cursor: pointer;">
                                    <div dnd-sortable="" draggable="true" ng-reflect-index="0" style="cursor: pointer;" class=""> <img alt="" tabindex="0" ng-reflect-name="0" src="../img/app-favicon-generic.png" class="ng-untouched ng-pristine ng-valid">
