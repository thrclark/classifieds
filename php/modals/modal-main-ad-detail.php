    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body view-ad">
                ...
                <a href="#" id="reportAd" class="font-italic small">Report this</a> </div>
            <div class="modal-footer view-ad">
                <div class="rbt-button-group">
                    ...
                    <a angulartics2on="click" angularticsaction="share" angularticscategory="ad" class="btn btn-outline-primary" href="mailto:?subject=IU%20Classifieds%3A%20Box%20of%20Stuff&amp;body=https%3A%2F%2Fclassifieds-stg.uits.iu.edu%2Fclassifieds%2Fpostings(details%3A180102)"> <i class="fa fa-envelope-o"></i> <span>
            ...
            <div class="modal-body report-post" style=" display:none">
                ...
                <form>
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">Additional information <small>(optional)</small></label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="5"></textarea>
                    </div>
                </form>
            </div>
            <div class="modal-footer report-post" style="display:none">
            ...
            <div class="modal-body view-policy" style="display:none">
            ...
            <div class="modal-footer view-policy" style="display:none"> <a href="#" class="btn btn-outline-primary" id="returnToReport">Back</a> </div>
            <div class="modal-body report-confirm" style=" display:none">
