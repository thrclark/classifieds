    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                  ...
                  <button type="button" class="btn btn-sm btn-primary" >Report This</button>
                <button type="button" class="btn btn-sm btn-primary">Share Ad</button>
                <button type="button" class="btn btn-sm btn-primary favorite"> <i aria-hidden="true" class="fa fa-star-o"></i> Watchlist</button>
                <button type="button" class="btn btn-sm btn-primary">Edit Ad</button>
                <button type="button" class="btn btn-sm btn-primary">Delete Ad</button>
            </div>
        </div>
    </div>
</div>
