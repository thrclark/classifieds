...
<div class="modal fade" id="post_detail_reported" tabindex="-1" role="dialog" aria-labelledby="post_detail_reported" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header demojs-view-reportedposting">
            ...
            <div class="modal-body demojs-view-reportedposting">
                <dl class="row">
                    <dt class="sr-only">
                ...
                <button class="btn btn-link font-weight-normal p-0 font-italic rbt-ts-14 demojs-btn-reportreportedad">Report this ad</button>
            </div>
            <div class="modal-footer demojs-view-reportedposting">
