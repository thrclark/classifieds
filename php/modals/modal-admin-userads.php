<div class="modal fade" id="pub_addetails" tabindex="-1" role="dialog" aria-labelledby="pub_addetails" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="">Ad Details</h5>
            ...
            <div class="modal-body">
                <dl class="row">
                    <dt class="col-sm-3 col-lg-2">Ad Title</dt>
                    <dd class="col-sm-9 col-lg-10">Sublease for Brownstone Apartments for Spring Semester </dd>
                    <dt class="col-sm-3 col-lg-2">Market</dt>
                    <dd class="col-sm-9 col-lg-10">IUB</dd>
                    <dt class="col-sm-3 col-lg-2">Category</dt>
                    <dd class="col-sm-9 col-lg-10">Jobs</dd>
                    ...
                    <dd class="col-sm-9 col-lg-10">idea@iu.edu</dd>
                    <dt class="col-sm-3 col-lg-2">Contact</dt>
                    <dd class="col-sm-9 col-lg-10">812-345-6789</dd>
                    <dt class="col-sm-3 col-lg-2">Price</dt>
                    <dd class="col-sm-9 col-lg-10">$500</dd>
                    <dt class="col-sm-3 col-lg-2">Status</dt>
                    <dd class="col-sm-9 col-lg-10">Active</dd>
                    <dt class="col-sm-3 col-lg-2">Ad Purpose</dt>
                    <dd class="col-sm-9 col-lg-10">Selling</dd>
                    <dt class="col-sm-3 col-lg-2">Post Date</dt>
                    <dd class="col-sm-9 col-lg-10">12/03/17</dd>
                    <dt class="col-sm-3 col-lg-2">Expire Date</dt>
                    <dd class="col-sm-9 col-lg-10">02/03/18</dd>
                </dl>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-link" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary btn-progressable" id=""> <span class="btn-label">Deactivate</span> </button>
            </div>
        </div>
    </div>
</div>
