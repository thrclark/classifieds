    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body report-post-confirm" style="display:none">
                <h4>Ad Removed</h4>
                <p>This ad was posted by the following user:</p>
                <p class="lead"> <i class="fa fa-user-circle-o" aria-hidden="true"></i> thrclark</p>
                <p>Would you like to ban or restrict this user?</p>
            </div>
        </div>
    </div>
</div>
