		...
		<div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row no-gutters mb-3">
                    ...
                    <div class="col-auto small"> <i class="fa fa-map-marker"></i> IU Kokomo </div>
                </div>
                <ccf-image-slider ng-reflect-image-urls="/ccf2-unt/postings/images/1800" >
                    <div class="overflow mb-3" style="touch-action: none; user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            <div class="rbt-button-group">
                                  <button class="btn btn-outline-primary" data-dismiss="modal" data-toggle="modal" data-target="#standardmodal-form-delete"> <span class="">Remove ad</span></button>
                            </div>
                        </div>
...
<div class="modal post-detail fade" id="standardmodal-form-delete" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="exampleModalLabel">Confirm Remove</h3>
                <button type="button" class="close" aria-label="Close" data-dismiss="modal"> <span class="rbt-icon-close"></span> </button>
            </div>
            <div class="modal-body">
                <p>This ad can not be restored once it has been removed. You have chosen to remove the following ad:</p>
				<h5>"Selmer VI Tenor Sax"</h5>
            </div>
            <div class="modal-footer">
                <div class="container-fluid px-0">
                    <div class="row align-items-center">
                        ...
                        <div class="rbt-button-group">
                            ...
                            <div class="rbt-button-group rbt-right-group admin-confirm">
                        	<!-- <div class="col-auto"> <a href="#" class="font-italic small">Report this</a> </div> -->
                        	<a href="admin-ads.php"><button type="button" class="btn btn-primary mod-actions"> <span class="">Confirm</span></button></a>
                        	<button type="button" class="btn btn-outline-primary mod-actions" data-dismiss="modal" data-toggle="modal" data-target="#admin_ad_detail"> <span class="">Cancel</span></button>
                        </div>
                        </div>
