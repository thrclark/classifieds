            ...
            <div class="main-content" id="main-content">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><b class="rbt-table-responsive-cell-label">
                                ...
                                <div class="small helper-text">Enter number of days to maintain expired ads.  Must be less than 730 days (2 years).</div>
                                </span></td>
                            <td><b class="rbt-table-responsive-cell-label">
                                <message key="admin.header.value">Value</message>
                        ...
                        <tr>
                            <td><b class="rbt-table-responsive-cell-label">
                                ...
                                <div class="small">Turn on access to the Live Data API. Default is no.</div>
                                </span></td>
                            <td><b class="rbt-table-responsive-cell-label">
                                <message key="admin.header.value">Value</message>
				...
				<td>
					...
					<span class="rbt-table-responsive-cell-content">
						Google Analytics ID
						<div class="small">The ID of the Google Analytics property to send events to.</div>
					</span>
				</td>
				<td>
					...
					<span class="rbt-table-responsive-cell-content">
                        ...
                        <tr>
                            <td><b class="rbt-table-responsive-cell-label">
                                ...
                                <div class="small helper-text">Choose a user attribute to map to a user's default market. The value of this attribute must match the unique key of the market.</div>
                                </span></td>
                            <td><b class="rbt-table-responsive-cell-label">
                                <message key="admin.header.value">Value</message>
                                </b> <span class="tablesaw-cell-content">
                        ...
                        <tr>
                            <td><b class="rbt-table-responsive-cell-label">
                                ...
                                <div class="small helper-text">Enter the domains of websites/applications you intend to trust so you can use live data.  This is also known as CORS (Cross-Origin Resource Sharing)</div>
                                </span></td>
                            <td><b class="rbt-table-responsive-cell-label">
                                <message key="admin.header.value">Value</message>
                                </b> <span class="tablesaw-cell-content"> <span> <span>
