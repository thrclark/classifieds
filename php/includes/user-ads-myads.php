    ...
    <div class="ad2 grid cat-vehicles">
        <div class="ad2-maincontainer">
            <div class="ad2-row">
                ...
                <div class="ad2-cont4 ad-title" style="word-wrap: break-word;">Selling: Honda Accord 2001 (150 K miles) </div>
                <div class="ad2-cont5 ad-price" style="word-wrap: break-word;">$2950</div>
                <div class="ad2-cont5-1 ad-type"> <i title="Selling" class="fa fa-tag" aria-hidden="true"></i> </div>
                <div class="w-100"></div>
                <div class="ad2-cont6 ad-description" style="word-wrap: break-word;">Great student car which is in mechanically perfect condition. Sunroof, A/C &amp; Heater works perfectly. Regular check and maintenance done at Firestone. No mechanical issues, clean title and car fax report available on request. Very reliable and low maintenance. Shall only accept cash, please feel free to get in touch for test drive and inspection. </div>
                <div class="ad2-cont7 ad-date">Oct 16</div>
                <div class="ad2-cont8 ad-location"><i class="fa fa-map-marker" aria-hidden="true"></i> IUK</div>
            </div>
        </div>
    ...
    <div class="ad2 grid cat-misc">
        <div class="ad2-maincontainer">
            <div class="ad2-row">
                ...
                <div class="ad2-cont4 ad-title" style="word-wrap: break-word;">Selling: Storage Open !! </div>
                <div class="ad2-cont5 ad-price" style="word-wrap: break-word;">$25/mo</div>
                <div class="ad2-cont5-1 ad-type"> <i title="Selling" class="fa fa-tag" aria-hidden="true"></i> </div>
                <div class="w-100"></div>
    ...
    <div class="ad2 grid cat-misc">
        <div class="ad2-maincontainer">
            <div class="ad2-row">
                ...
                <div class="ad2-cont4 ad-title" style="word-wrap: break-word;">Selling: 38 pieces Blue Indies Dish Set </div>
                <div class="ad2-cont5 ad-price" style="word-wrap: break-word;">$50</div>
                <div class="ad2-cont5-1 ad-type"> <i title="Selling" class="fa fa-tag" aria-hidden="true"></i> </div>
                <div class="w-100"></div>
                <div class="ad2-cont6 ad-description" style="word-wrap: break-word;">Johnson Brothers Blue Indies Ironstone Dinnerware
