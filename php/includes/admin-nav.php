    ...
    <ul class="rbt-sidebar-nav">
        <li><span class="text-uppercase">Moderator</span>
            <ul class="list-unstyled">
                ...
                <li <?php if ($page_title == 'Ads') { echo 'class="active"'; } ?>><a href="admin-ads.php">Ads</a></li>
                <li <?php if ($page_title == 'Restricted users') { echo 'class="active"'; } ?>><a href="admin-restricted.php">Restricted users</a></li>
        ...
        <li><span class="text-uppercase">Post MVP</span>
            <ul class="list-unstyled">
                <li <?php if ($page_title == 'Moderator') { echo 'class="active"'; } ?>><a href="admin-ads-postmvp.php">Moderator</a></li>
                <li <?php if ($page_title == 'Moderate Ads &amp; Users') { echo 'class="active"'; } ?>><a href="admin-userads.php">Moderate ads &amp; users</a> </li>
            </ul>
        </li>
    </ul>
</nav>
