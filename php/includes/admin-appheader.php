...
<a  href="main-home.php"class="rbt-brand-title"><strong>Classifieds</strong> Admin</a></span> </div>
...
<a href="admin-apidocs.php" class="dropdown-item">API Documentation</a></div>
                            </li>
                            <li class="nav-item dropdown"> 
...
<a href="admin-reloadcache.php" class="dropdown-item" >Reload Cache </a> </div>
                            </li>
...
<a href="admin-categories.php">Categories</a> </li>
            <li class="list-group-item"> 
<a href="admin-markets.php">Markets</a> </li>
            <li class="list-group-item"> 
