                    ...
                    <div class="col-auto d-none d-lg-block">
                        <ul class="nav align-items-center">
                            ...
                            <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Moderation</a>
                                <div class="dropdown-menu"> <a <?php if ($page_title == 'Ads') { echo 'class="dropdown-item active"'; } ?> href="admin-ads.php" class="dropdown-item">Ads</a> <a <?php if ($page_title == 'Restricted users') { echo 'class="dropdown-item active"'; } ?> href="#" class="dropdown-item">Restricted users</a> </div>
                            </li>
                            <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Settings</a>
                                <div class="dropdown-menu"> <a <?php if ($page_title == 'General settings') { echo 'class="dropdown-item active"'; } ?> href="admin-generalsettings.php" class="dropdown-item">General settings</a> <a <?php if ($page_title == 'Branding') { echo 'class="dropdown-item active"'; } ?> href="admin-branding.php" class="dropdown-item">Branding</a> <a <?php if ($page_title == 'Categories') { echo 'class="dropdown-item active"'; } ?> href="admin-categories.php" class="dropdown-item">Categories</a> <a <?php if ($page_title == 'Markets') { echo 'class="dropdown-item active"'; } ?> href="admin-markets.php" class="dropdown-item">Markets</a> <a <?php if ($page_title == 'LDAP configuration') { echo 'class="dropdown-item active"'; } ?> href="admin-ldap.php" class="dropdown-item">LDAP Configuration</a> <a <?php if ($page_title == 'API accounts') { echo 'class="dropdown-item active"'; } ?> href="admin-apiaccounts.php" class="dropdown-item">API Accounts</a> <a <?php if ($page_title == 'API documentation') { echo 'class="dropdown-item active"'; } ?> href="admin-apidocs.php" class="dropdown-item">API Documentation</a> </div>
                            </li>
...
<div class="rbt-drawer">
    <nav>
        ...
        <ul class="list-group ">
            ...
            <li class="list-group-item"> <a href="">Restricted users</a> </li>
        </ul>
        ...
        <ul class="list-group ">
            ...
            <li class="list-group-item"> <a href="admin-markets.php">Markets</a> </li>
