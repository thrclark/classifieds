...
<header class="rbt-app-header">
    <div class="container">
        <div class="row justify-content-between align-items-center"> 
            ...
            <!--App Title-->
            <div class="col rbt-brand-title-container"> <span class="rbt-header-title"> <a href="main-home.php"class="rbt-brand-title"> <!--<strong>Classifieds</strong>--> <span class="rbt-ts-14">Administration</span></a> </span> </div>
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <ul class="nav align-items-center">
                            ...
                            <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Moderation</a>
                                <div class="dropdown-menu"> <a <?php if ($page_title == 'Ads') { echo 'class="dropdown-item active"'; } ?> href="admin-ads.php" class="dropdown-item">Ads</a> <a <?php if ($page_title == 'Restricted users') { echo 'class="dropdown-item active"'; } ?> href="admin-restrictedusers.php" class="dropdown-item">Restricted users</a> <a <?php if ($page_title == 'Reindex ad') { echo 'class="dropdown-item active"'; } ?> href="admin-reindexad.php" class="dropdown-item">Reindex ad</a> </div>
                            </li>
                            <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Settings</a>
                                <div class="dropdown-menu"> <a <?php if ($page_title == 'General settings') { echo 'class="dropdown-item active"'; } ?> href="admin-generalsettings.php" class="dropdown-item">General settings</a> <a <?php if ($page_title == 'Categories') { echo 'class="dropdown-item active"'; } ?> href="admin-categories.php" class="dropdown-item">Categories</a> <a <?php if ($page_title == 'Markets') { echo 'class="dropdown-item active"'; } ?> href="admin-campuses.php" class="dropdown-item">Campuses</a> <a <?php if ($page_title == 'LDAP configuration') { echo 'class="dropdown-item active"'; } ?> href="admin-ldap.php" class="dropdown-item">LDAP Configuration</a> <a <?php if ($page_title == 'Branding') { echo 'class="dropdown-item active"'; } ?> href="admin-branding.php" class="dropdown-item">Branding</a> <a <?php if ($page_title == 'API accounts') { echo 'class="dropdown-item active"'; } ?> href="admin-apiaccounts.php" class="dropdown-item">API Accounts</a> <a <?php if ($page_title == 'API docmentation') { echo 'class="dropdown-item active"'; } ?> href="admin-apidocs.php" class="dropdown-item">API Documentation</a> </div>
                            </li>
...
<div class="rbt-drawer">
    <nav>
        ...
        <ul class="list-group ">
            <li class="list-group-item"> <a href="admin-ads.php">Ads</a> </li>
            <li class="list-group-item"> <a href="admin-restrictedusers.php">Restricted users</a> </li>
