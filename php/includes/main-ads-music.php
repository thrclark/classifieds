...
<div class="row">
    <div class="postitem grid cat-music"  data-toggle="modal" data-target="#post_detail">
        <div class="postitem-container">
            <div class="postitem-row">
                ...
                <div class="postitem-postdate">Sep 16</div> <div class="postitem-postlocation"><i class="fa fa-map-marker" aria-hidden="true"></i> IUK</div>
            </div>
        </div>
    </div>
    <div class="postitem grid cat-music"  data-toggle="modal" data-target="#post_detail">
    ...
    <div class="postitem grid cat-music"  data-toggle="modal" data-target="#post_detail">
        <div class="postitem-container">
            <div class="postitem-row">
                ...
                <div class="postitem-postdate">Sep 14</div> <div class="postitem-postlocation"><i class="fa fa-map-marker" aria-hidden="true"></i> IUK</div>
            </div>
        </div>
    </div>
    <div class="postitem grid cat-music"  data-toggle="modal" data-target="#post_detail">
        <div class="postitem-container">
            <div class="postitem-row">
                ...
                <div class="postitem-postdate">Sep 13</div> <div class="postitem-postlocation"><i class="fa fa-map-marker" aria-hidden="true"></i> IUK</div>
            </div>
        </div>
    </div>
    <div class="postitem grid cat-music"  data-toggle="modal" data-target="#post_detail">
        <div class="postitem-container">
            <div class="postitem-row">
                ...
                <div class="postitem-postdate">Sep 7</div> <div class="postitem-postlocation"><i class="fa fa-map-marker" aria-hidden="true"></i> IUK</div>
            </div>
        </div>
    </div>
    ...
    <div class="postitem grid cat-music"  data-toggle="modal" data-target="#post_detail">
        <div class="postitem-container">
            <div class="postitem-row">
                ...
                <div class="postitem-postdate">Sep 11</div> <div class="postitem-postlocation"><i class="fa fa-map-marker" aria-hidden="true"></i> IUB</div>
            </div>
        </div>
    </div>
    <div class="postitem grid cat-music"  data-toggle="modal" data-target="#post_detail">
        <div class="postitem-container">
            <div class="postitem-row">
                ...
                <div class="postitem-postdate">Sep 9</div> <div class="postitem-postlocation"><i class="fa fa-map-marker" aria-hidden="true"></i> IUB</div>
            </div>
        </div>
    </div>
    <div class="postitem grid cat-music"  data-toggle="modal" data-target="#post_detail">
    ...
    <div class="postitem grid cat-music"  data-toggle="modal" data-target="#post_detail">
        <div class="postitem-container">
            <div class="postitem-row">
                ...
                <div class="postitem-postdate">Sep 7</div> <div class="postitem-postlocation"><i class="fa fa-map-marker" aria-hidden="true"></i> IUB</div>
            </div>
        </div>
    </div>
    <div class="postitem grid cat-music"  data-toggle="modal" data-target="#post_detail">
    ...
    <div class="postitem grid cat-music"  data-toggle="modal" data-target="#post_detail">
        <div class="postitem-container">
            <div class="postitem-row">
                ...
                <div class="postitem-postdate">Sep 6</div> <div class="postitem-postlocation"><i class="fa fa-map-marker" aria-hidden="true"></i> IUB</div>
            </div>
        </div>
    </div>
    <div class="postitem grid cat-music"  data-toggle="modal" data-target="#post_detail">
        <div class="postitem-container">
            <div class="postitem-row">
                ...
                <div class="postitem-postdate">Sep 4</div> <div class="postitem-postlocation"><i class="fa fa-map-marker" aria-hidden="true"></i> IUB</div>
            </div>
        </div>
    </div>
    <div class="postitem grid cat-music"  data-toggle="modal" data-target="#post_detail">
    ...
    <div class="postitem grid cat-music"  data-toggle="modal" data-target="#post_detail">
        <div class="postitem-container">
            <div class="postitem-row">
                ...
                <div class="postitem-postdate">Sep 3</div> <div class="postitem-postlocation"><i class="fa fa-map-marker" aria-hidden="true"></i> IUB</div>
            </div>
        </div>
    </div>
    <div class="postitem grid cat-music"  data-toggle="modal" data-target="#post_detail">
        <div class="postitem-container">
            <div class="postitem-row">
                ...
                <div class="postitem-postdate">Sep 2</div> <div class="postitem-postlocation"><i class="fa fa-map-marker" aria-hidden="true"></i> IUB</div>
            </div>
        </div>
    </div>
    <div class="postitem grid cat-music"  data-toggle="modal" data-target="#post_detail">
