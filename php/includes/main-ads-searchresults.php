    ...
    <div class="postitem grid cat-electronics"  data-toggle="modal" data-target="#post_detail">
        <div class="postitem-container">
            <div class="postitem-row">
                ...
                <div class="postitem-postdate">Oct 16</div> <div class="postitem-postlocation"><i class="fa fa-map-marker" aria-hidden="true"></i> IUB</div>
            </div>
        </div>
    </div>
    <div class="postitem grid cat-electronics"  data-toggle="modal" data-target="#post_detail">
        <div class="postitem-container">
            <div class="postitem-row">
                ...
                <div class="w-100"></div>
                <div class="postitem-description">Can meet you at Verizon store. Clean esn. Excellent condition with AppleCare+ until Sept 2018. See pictures! Phone only.
 </div>
                <div class="postitem-postdate">Oct 16</div> <div class="postitem-postlocation"><i class="fa fa-map-marker" aria-hidden="true"></i> IUB</div>
            </div>
        </div>
    ...
    <div class="postitem grid cat-electronics"  data-toggle="modal" data-target="#post_detail">
        <div class="postitem-container">
            <div class="postitem-row">
                ...
                <div class="postitem-postdate">Oct 16</div> <div class="postitem-postlocation"><i class="fa fa-map-marker" aria-hidden="true"></i> IUPUI</div>
            </div>
        </div>
    </div>
    <div class="postitem grid cat-electronics"  data-toggle="modal" data-target="#post_detail">
