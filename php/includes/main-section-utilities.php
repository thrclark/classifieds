...
<div class="section-head-utilities">
    <div class="row align-items-center">
        ...
        <div class="ccf-scrollmenu d-sm-none">
            	<div class="dropdown">
                	<button class="btn btn-link btn-outline-primary dropdown-toggle" type="button" id="selectMarket" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                		<span class="d-inline d-sm-none">IU Bloomington (IUB)</span>
                	</button>
                	<div class="dropdown-menu" aria-labelledby="selectMarket">
                    	<h3 class="dropdown-header">Set location</h3>
                    	<div class="dropdown-divider"></div>
            	...
            	<div class="dropdown">
                	<button class="btn btn-link btn-outline-primary dropdown-toggle" type="button" id="select_type" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                		<span class="d-inline d-sm-none">For Sale</span>
                	</button>
                	<div class="dropdown-menu" aria-labelledby="select_type">
                    	<h3 class="dropdown-header">Filter by type</h3>
                    	<div class="dropdown-divider"></div>
            	...
            	<div class="dropdown util-sort">
                    <button class="btn btn-link btn-outline-primary dropdown-toggle" type="button" id="select_sort" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
