...
<div class="section-head-utilities">
    <div class="row align-items-center">
        <div class="col-auto"  <?php if ($page_title == 'cat_watchlist') { echo 'style=" display:none"'; } ?> <?php if ($page_title == 'cat_myads') { echo 'style=" display:none"'; } ?>>
            <div class="dropdown">
                <button class="btn btn-link dropdown-toggle" type="button" id="selectMarket" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <span class="d-inline d-sm-none">IUK</span> <span class="d-none d-sm-inline">IU Kokomo</span> </button>
        ...
        <div class="col text-right">
            ...
            <div class="btn-group util-view-switch d-none d-sm-inline" data-toggle="buttons" style="font-size:0px">
