...
<div class="section-head-utilities">
    <div class="row align-items-center">
        <div class="col-auto"  <?php if ($page_title == 'cat_watchlist') { echo 'style=" display:none"'; } ?> <?php if ($page_title == 'cat_myads') { echo 'style=" display:none"'; } ?>>
            <div class="dropdown"> <button class="btn btn-link dropdown-toggle" type="button" id="selectMarket" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <span class="d-inline d-sm-none">IUK</span> <span class="d-none d-sm-inline">IU Kokomo</span> </button>
...
<a class="dropdown-item" href="#"> IU South (IUS)</a> </div>
            </div>
        </div>
        <div class="col-auto">
            <div class="dropdown">	
...
<a class="dropdown-item" href="#">By date</a> </div>
                </div>
            </div>
