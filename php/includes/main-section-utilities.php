    ...
    <div class="row align-items-center">
        ...
        <div class="col-auto p-0">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="select_type">
                    ...
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="#"> For sale</a> <a class="dropdown-item" href="#"> Seeking</a> <a class="dropdown-item" href="#">All types</a> </div>
            </div>
        </div>
        <div class="col text-right">
            ...
            <div class="btn-group d-none d-sm-inline" role="group" style="font-size: 0;">
                <button class="btn btn-sm btn-outline-primary active" type="button" id="set_grid"> <span class="sr-only">
                <message key="main.view.grid">Grid View</message>
                </span> <i aria-hidden="true" class="fa fa-th-large"></i> </button>
                <button class="btn btn-sm btn-outline-primary" type="button" id="set_thumb"> <span class="sr-only">
                <message key="main.view.thumb">Thunbnail View</message>
                </span> <i aria-hidden="true" class="fa fa-list-ul"></i> </button>
                <button class="btn btn-sm btn-outline-primary" type="button" id="set_list"> <span class="sr-only">
                <message key="main.view.list">List View</message>
                </span> <i aria-hidden="true" class="fa fa-list"></i> </button>
            </div>
        </div>
    </div>
</div>
