        ...
        <div class="search-container">
            <div class="row align-items-center">
                ...
                <div class="col-auto search-geo"><i class="fa fa-map-marker" aria-hidden="true"></i>
                    <div class="dropdown show"> <span class="dropdown-toggle" role="button" id="select-geo-mobile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <span class="short-name">All</span> <span class="long-name">All Campuses</span> </span>
