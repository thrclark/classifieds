...
<div class="row">
    <div class="ad2 grid cat-electronics">
        <div class="ad2-maincontainer">
            <div class="ad2-row">
                <div class="ad2-cont1">
                    <div class="ad-image" style="background-image:url(../img/ad-pics/iphone1.jpg)"> </div>
                </div>
                <div class="ad2-cont2">
    ...
    <div class="ad2 grid cat-electronics">
        <div class="ad2-maincontainer">
            <div class="ad2-row">
                <div class="ad2-cont1">
                    <div class="ad-image" style="background-image:url(../img/ad-pics/iphone2.jpg)"> </div>
                </div>
                <div class="ad2-cont2">
                    <div class="watchlist-set"> <i aria-hidden="true" class="fa fa-heart-o"></i> </div>
                </div>
    ...
    <div class="ad2 grid cat-electronics">
        <div class="ad2-maincontainer">
            <div class="ad2-row">
                <div class="ad2-cont1">
                    <div class="ad-image" style="background-image:url(../img/ad-pics/iphone3.jpg)"> </div>
                </div>
                <div class="ad2-cont2">
                    <div class="watchlist-set"> <i aria-hidden="true" class="fa fa-heart-o"></i> </div>
                </div>
    ...
    <div class="ad2 grid cat-electronics">
        <div class="ad2-maincontainer">
            <div class="ad2-row">
                <div class="ad2-cont1">
                    <div class="ad-image" style="background-image:url(../img/ad-pics/iphone4.jpg)"> </div>
                </div>
                <div class="ad2-cont2">
                    <div class="watchlist-set"> <i aria-hidden="true" class="fa fa-heart-o"></i> </div>
                </div>
    ...
    <div class="ad2 grid cat-electronics">
        <div class="ad2-maincontainer">
            <div class="ad2-row">
                <div class="ad2-cont1">
                    <div class="ad-image" style="background-image:url(../img/ad-pics/iphone5.jpg)"> </div>
                </div>
                <div class="ad2-cont2">
                    <div class="watchlist-set"> <i aria-hidden="true" class="fa fa-heart-o"></i> </div>
                </div>
    ...
    <div class="ad2 grid cat-electronics">
        <div class="ad2-maincontainer">
            <div class="ad2-row">
                <div class="ad2-cont1">
                    <div class="ad-image" style="background-image:url(../img/ad-pics/iphone6.jpg)"> </div>
                </div>
                <div class="ad2-cont2">
                    <div class="watchlist-set"> <i aria-hidden="true" class="fa fa-heart-o"></i> </div>
                </div>
                ...
                <div class="ad2-cont7 ad-date">Oct 16</div>
                <div class="ad2-cont8 ad-location"><i class="fa fa-map-marker" aria-hidden="true"></i> IUPUI</div>
            </div>
        </div>
    </div>
    <div class="ad2 grid cat-electronics">
        <div class="ad2-maincontainer">
            <div class="ad2-row">
                <div class="ad2-cont1">
                    <div class="ad-image" style="background-image:url(../img/ad-pics/iphone7.jpg)"> </div>
                </div>
                <div class="ad2-cont2">
                    <div class="watchlist-set"> <i aria-hidden="true" class="fa fa-heart-o"></i> </div>
                </div>
    ...
    <div class="ad2 grid cat-electronics">
        <div class="ad2-maincontainer">
            <div class="ad2-row">
                <div class="ad2-cont1">
                    <div class="ad-image" style="background-image:url(../img/ad-pics/iphone8.jpg)"> </div>
                </div>
                <div class="ad2-cont2">
                    <div class="watchlist-set"> <i aria-hidden="true" class="fa fa-heart-o"></i> </div>
                </div>
    ...
    <div class="ad2 grid cat-electronics">
        <div class="ad2-maincontainer">
            <div class="ad2-row">
                <div class="ad2-cont1">
                    <div class="ad-image" style="background-image:url(../img/ad-pics/iphone9.jpg)"> </div>
                </div>
                <div class="ad2-cont2">
                    <div class="watchlist-set"> <i aria-hidden="true" class="fa fa-heart-o"></i> </div>
                </div>
