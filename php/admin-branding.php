...
<div class="container">
                ...
                <table class="table table-sm table-actions tablesaw tablesaw-stack" data-tablesaw-mode="stack">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><button type="button" class="btn btn-outline-secondary btn-sm" data-toggle="modal" data-target="#pub_titledisplay">Edit</button></td>
                        </tr>
                        <tr>
                            <td>Primary Brand Color
                                <div class="small text-muted helper-text">Choose the color to be used for the header background & accent colors.</div></td>
    ...
    vertical-align: middle;"></div>
                            ...
                            <td><button type="button" class="btn btn-outline-secondary btn-sm" data-toggle="modal" data-target="#pub_color">Edit</button></td>
                        </tr>
                        <tr>
                            <td>Font Family for Headers
                                <div class="small text-muted helper-text">Choose a font family to be used for all headers.</div></td>
                            <td> BentonSansBold</td>
                            <td><button type="button" class="btn btn-outline-secondary btn-sm" data-toggle="modal" data-target="#pub_fontheader">Edit</button></td>
                        </tr>
                        <tr>
                            <td>Font Family for Body Text
                                <div class="small text-muted helper-text">Choose a font family to be used for the body text.</div></td>
                            <td> BentonSans</td>
                            <td><button type="button" class="btn btn-outline-secondary btn-sm" data-toggle="modal" data-target="#pub_fontbody">Edit</button></td>
                        </tr>
                        <tr>
                            <td>Custom Header HTML (optional)
                                <div class="small text-muted helper-text">Specify optional HTML markup to be displayed at the top of the application views.</div></td>
                            <td><div class="code" style=" height:70px"> <code>&lt;div id=&quot;custom_header&quot;&gt;
                                    ...
                                    &lt;/div&gt;
                                    &lt;/div&gt; &lt;/div&gt;</code></div></td>
                            <td><button type="button" class="btn btn-outline-secondary btn-sm" data-toggle="modal" data-target="#pub_customheader">Edit</button></td>
                        </tr>
                        <tr>
                            <td>Custom Footer HTML (optional)
                                <div class="small text-muted helper-text">Specify optional HTML markup to be displayed at the bottom of the application views.</div></td>
                            ...
                            <td><button type="button" class="btn btn-outline-secondary btn-sm" data-toggle="modal" data-target="#pub_customfooter">Edit</button></td>
                        </tr>
                        <tr>
                            ...
                            <td><button type="button" class="btn btn-outline-secondary btn-sm" data-toggle="modal" data-target="#pub_customcss">Edit</button></td>
                        </tr>
                    </tbody>
                </table>
            </div>
