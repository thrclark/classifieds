                        ...
                        <div class="col-12 col-lg-10 col-xl-8">
                            <form novalidate class="ng-pristine ng-invalid ng-touched">
                                <div class="form-group">
                                    ...
                                    <div class="ccf-instructional-text" id="titleDirections">
                                        <message key="admin.apiAccount.field.name.directions">A unique name to identify this API Account.</message>
                                    </div>
                                    <countdown>
                                ...
                                <div class="form-group">
                                    <label class="control-label" id="statusLabel">
                                    ...
                                    <errors controlname="status"> </errors>
                                </div>
                                <div class="form-group">
                                    <div class="form-check mb-3">
                                        ...
                                        <div class="ccf-instructional-text">
                                            <message key="admin.apiAccount.field.expireDate.directions">This account may be renewed within 30 days of expiration (Wed May 30 2018).</message>
                                        </div>
                                        </label>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <div class="ccf-instructional-text">
                                            <message key="admin.apiAccount.field.locked.directions">Unlock this API Account so it may be used again.</message>
                                        </div>
                                        </label>
                                        <errors controlname="locked"> </errors>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label" id="resourceQuotaLabel">
                                        <message key="admin.apiAccount.field.resourceQuota">Maximum Number of New Resources</message>
                                    </label>
                                ...
                                <div class="form-group">
                                    <label class="control-label" id="emailLabel">
                                        <message key="admin.apiAccount.field.email">Email</message>
                                    </label>
                                    <div class="ccf-instructional-text" id="emailDirections">
                                        <message key="admin.apiAccount.field.email.directions">The email is used to send a daily reminder starting 30 days from the API Account expiring.</message>
                                    </div>
                                    <countdown>
                                        <div class="rbt-charcount">
                                ...
                                <div class="form-group">
                                    <label class="control-label" id="authenticationTypeLabel">
                                        <message key="admin.apiAccount.field.authType">Authentication Type</message>
                                    </label>
                                    ...
                                    <errors controlname="authenticationType"> </errors>
                                </div>
                                ...
                                <div class="rbt-button-group mb-5">
                                    ...
                                    <a class="btn btn-outline-primary" routerlink="/apiAccounts" href="admin-apiaccounts.php">
