                     ...
                     <div class="mobile-panel-header">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-primary" type="button" onclick="location.href = 'main-searchresults.php';"> <i aria-hidden="true" class="fa fa-search"></i> <span class="sr-only"><message>Search</message></span></button>
                            </div>
                        </div>
                </div>
            </div>
